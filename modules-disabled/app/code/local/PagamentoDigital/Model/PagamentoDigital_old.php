<?php
/**
* Pagamento Digital Module Adapter
*/

class PagamentoDigital_Model_PagamentoDigital extends Mage_Payment_Model_Method_Abstract {
  ...
  * @var string [a-z0-9_]
  */
  protected $_code = 'PagamentoDigital';

  protected $_allowCurrencyCode = array('BRL');

  protected $_formBlockType = 'PagamentoDigital_Block_Form';
   ...
   */
     ...
     *
     * @return Mage_PagamentoDigital_Model_Session
     */
    ...
    {
        $block = $this->getLayout()->createBlock('PagamentoDigital/form', $name)
            ->setMethod('PagamentoDigital')
            ->setPayment($this->getPayment())
            ->setTemplate('PagamentoDigital/form.phtml');
   ...
   public function getCheckoutFormFields() {
	...
	$items = $this->getQuote()->getAllItems();
        ...
        if ($items) {
            ...
            foreach($items as $item){
			    ...
			    'item_peso_'.$i    => 0,
				//'item_peso_'.$i    => round($item->getWeight()),   //  para o PagamentoDigital calcular o frete, tem que passar via Post o peso arredondado, senão dá erro  //  desligado para quando o modulo de correio no Magento estiver funcionando
			    'item_frete_'.$i   => 0,
	...
	//passa o valor do frete total em uma única variavel para o pagamentodigital, utilizado junto com o modulo de correio
