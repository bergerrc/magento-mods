 ...
 */
abstract class PagamentoDigital_Model_Abstract extends Mage_Payment_Model_Method_Abstract
{
    /**
     * Get Paypal API Model
     *
     * @return PagamentoDigital_Model_Api_Nvp
     */
    public function getApi()
    {
        return Mage::getSingleton('pagamentodigital/api_nvp');
    }
