 ...
 */
abstract class PagamentoDigital_Model_Api_Abstract extends Varien_Object
{
    ...
    {
        if (!$this->hasData($key)) {
             $value = Mage::getStoreConfig('pagamentodigital/wpp/'.$key);
    ...
    {
        return Mage::getUrl($this->getConfigData('api_error_url', 'pagamentodigital/express/error'));
    }
    ...
    {
        return Mage::getUrl($this->getConfigData('api_return_url', 'pagamentodigital/express/return'));
    }
    ...
    {
        return Mage::getUrl($this->getConfigData('api_cancel_url', 'pagamentodigital/express/cancel'));
    }
    ...
    {
        $types = array('AE'=>Mage::helper('pagamentodigital')->__('Amex'), 'VI'=>Mage::helper('pagamentodigital')->__('Visa'), 'MC'=>Mage::helper('pagamentodigital')->__('MasterCard'), 'DI'=>Mage::helper('pagamentodigital')->__('Discover'));
