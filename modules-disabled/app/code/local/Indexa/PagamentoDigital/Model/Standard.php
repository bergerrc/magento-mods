...
class Indexa_PagamentoDigital_Model_Standard extends Mage_Payment_Model_Method_Abstract
{
	...
	public function getStandardCheckoutFormFields() {
		...
		$storeId = $this->getCheckout()->getPagamentodigitalStandardStoreId()? 
						$this->getCheckout()->getPagamentodigitalStandardStoreId(): 
						$this->getQuote()->getStoreId();
      	$sArr = array(
            'email_loja'        =>  $this->getConfigData('emailID', $storeId),
            'tipo_integracao'   => "PAD",
		...
		if ($this->getConfigData('retorno',$storeId) != '') {
	    	$sArr = array_merge($sArr, array('url_retorno' => Mage::getUrl($this->getConfigData('retorno',$storeId))));
