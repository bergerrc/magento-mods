...
class PagSeguro_Model_Standard extends Mage_Payment_Model_Method_Abstract {
    ...
    public function getStandardCheckoutFormFields() {
        ...
        $sArr = array(
                'encoding'          => 'UTF-8',
                'email_cobranca'    => $this->getConfigData('emailID',$storeId),
                'Tipo'              => "CP",
                'Moeda'             => $currency_code,
                ...
                'cliente_num'       => $numero,
                'cliente_compl'     => (($a->getStreet3() !=='' || $a->getStreet4() !=='')? $a->getStreet3(): $a->getStreet2()),
                'cliente_bairro'    => ($a->getStreet4() !==''? $a->getStreet4(): $a->getStreet3()),
        ...
        if ($items) {
            ...
            $active = $module->getConfigData('active',$storeId);
