 ...
 */
class Coobus_Catalog_Block_Adminhtml_Edit_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    public function __construct()
    {
        ...
        $this->setId('is_featured_products');
    ...
    {	
    	...
    	if($temp)
    	{
            ...
            ->joinAttribute('is_featured', 'catalog_product/is_featured', 'entity_id', null, 'left', $store->getId())
            ->addAttributeToFilter('is_featured','1');
            
            //echo $_prod->getSelect();            
