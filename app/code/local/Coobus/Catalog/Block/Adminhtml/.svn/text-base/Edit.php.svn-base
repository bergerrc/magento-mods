 ...
 */
class Coobus_Catalog_Block_Adminhtml_Edit extends Mage_Adminhtml_Block_Widget_Grid_Container
{

		protected $_saveButtonLabel = 'Save Featured Products';
		protected $_inchooUrl = '';
	
		public function __construct()
    		{
    		
    		
    		$this->_blockGroup = 'coobus_catalog';
        	$this->_controller = 'adminhtml_edit';

	        // adminexample/adminhtml_test_grid
	        
        	
        
    	    $this->_headerText = Mage::helper('coobus_catalog')->__('Featured Products');
            ...
            'label'     => Mage::helper('coobus_catalog')->__($this->_saveButtonLabel),
