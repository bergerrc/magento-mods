...
class Coobus_Catalog_Block_System_Html
	extends Mage_Adminhtml_Block_System_Config_Form_Fieldset
{
    ...
    public function render(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $html .= "
            ...
            Enhanced Grid v". Mage::getConfig()->getNode('modules/Coobus_Catalog/version')  .". <a href='http://www.magentocommerce.com/magento-connect/WDCA/extension/748/enhanced-product-grid' target='_blank'>Click here for updates.</a><BR /> 

            <iframe src=\"http://127.0.0.1/m/?a=coobus_catalog&v=".
                    Mage::getConfig()->getNode('modules/Coobus_Catalog/version') ."&m=". 
                    Mage::getVersion() ."&p=". 
