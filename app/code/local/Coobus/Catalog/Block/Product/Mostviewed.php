...
class Coobus_Catalog_Block_Product_Mostviewed extends Coobus_Catalog_Block_Product_Tab 
{
    protected $tabname = "mostviewedproducts";    
    
    public function getTimeLimit() 
    {
        return intval(Mage::getStoreConfig('catalog/mostviewedproducts/time_limit_in_days'));
    }
    ...
    {   
        ...
        $collection->setVisibility(Mage::getSingleton('catalog/product_visibility')->getVisibleInCatalogIds());
            ...
            if ($this->getTimeLimit()) {
                ...
                $collection = $collection->addViewsCount($startDate, $todayDate);
            } else {
                $collection = $collection->addViewsCount();
            }        
