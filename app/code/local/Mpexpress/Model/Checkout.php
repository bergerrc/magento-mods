    ...
    public function __construct(){
     ...
     $this->debug = $standard->getConfigData('debug');
      ...
      public function GetCheckout($data,$excludes){
            ...
            $header = array('Content-Type:application/json', 'User-Agent:MercadoPago Magento-1.4.xto1.5.x Cart v1.0.0', 'Accept: application/json');
            $dados = $this->DoPost($opt,$url,$header,'201','json','post');
/*	     if ( $this->debug == '' or $this->debug == 0 )
              $link = $dados['init_point'];
	     else
*/
		$link = $dados['sandbox_init_point'];
